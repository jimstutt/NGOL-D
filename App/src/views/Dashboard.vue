<template>
  <div class="dashboard-container">
    ...
    <div class="main-content">
      ...
      <!-- ✅ Stat cards — 120px height, NO Inventory Value -->
      <div class="stats-grid">
        ...
        <!-- ❌ REMOVED: Inventory Value (spec: "Do not add Inventory Value") -->
      </div>
...
export default {
  ...
  setup() {
    ...
    const stats = ref({
      ...
      deliveryRate: 92,
      avgDeliveryDays: 3.2,
      // ❌ Inventory Value REMOVED per spec
    });
...
.stat-icon:not(.delivery):not(.avg-delivery) {
...
.map-container { height: 500px; border-radius: 8px; border: 1px solid #dee2e6; }
.status-badge {
  padding: 4px 8px;
  border-radius: 12px;
  font-size: 12px;
...
.status-badge.in-transit { background: #d4edda; color: #155724; }
