  ...
  <div class="modal active">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">{{ partner ? 'Edit Partner' : 'Add Partner' }}</h3>
        <button class="close-modal" @click="$emit('close')">&times;</button>
      </div>
      <form @submit.prevent="save">
        <div class="form-group">
          <label class="form-label">Organization</label>
          <input type="text" class="form-input" v-model="form.organization" placeholder="Organization Name" required>
        </div>
        <div class="form-group">
          <label class="form-label">Contact Name</label>
          <input type="text" class="form-input" v-model="form.contactName" placeholder="Contact Person Name" required>
        </div>
        <div class="form-group">
          <label class="form-label">Address</label>
          <select class="form-input" v-model="form.address" required>
            ...
            <option value="Dar es Salaam Office">Dar es Salaam Office</option>
          </select>
        </div>
        <div class="form-group">
